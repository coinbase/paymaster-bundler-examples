...
This example uses the [Safe{Core} SDK](https://docs.safe.global/sdk/overview) to create an [ERC-4337](https://www.erc4337.io/) compatible Safe Smart Account and send a sponsored transaction.

We'll be minting an NFT on Base Sepolia using Coinbase Cloud's Paymaster & Bundler.
